...
const I18N = {
  vi: {
    ...
    hint_expense_amount_negative: 'Nhập số âm nếu đây là khoản sale bù (VD: sale trả trước tiền để giảm giá cho khách) — sẽ được cộng thêm vào doanh thu của chủ đầu tư thay vì trừ đi.',
  ...
  en: {
    ...
    hint_expense_amount_negative: 'Enter a negative number for a saler-covered discount (e.g. the saler pays part of the rent upfront so the tenant gets a lower price) — this adds to the investor\'s revenue instead of subtracting from it.',
